...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Auragrain exports premium Pakistani Basmati and specialty rice to over 60 countries. Trusted by importers, distributors, and food companies worldwide." },
      { property: "og:title", content: "Auragrain — Premium Pakistani Rice Exported Worldwide" },
      { property: "og:description", content: "Premium Basmati and specialty rice delivered to international markets with uncompromising quality." },
